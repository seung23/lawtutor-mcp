...
| 도구 | n | Recall@5 | MRR |
|------|---|----------|-----|
| 판례 의미 검색 | 20 | **0.45** | 0.30 |
| 헌재결정 의미 검색 | 14 | **0.36** | 0.21 |

판례·결정례 의미 검색은 579K/99K 규모 컬렉션에서 교과서 대표 판례 1건을 top-5에 포함시키는 것이 구조적으로 어려워 Recall이 낮다. 피인용수·전원합의체·섹션타입 기반 리랭킹을 적용하여 개선 중이며, 상세 분석은 [평가 보고서](docs/EVALUATION.md) 참조.
